        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kicker = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ...
                    ImageAlt = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
                    CardClass = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceCents = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    Material = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    ...
                    CardClass = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    HighlightsText = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_IsPublished_DisplayOrder",
                table: "Products",
